...
const DynamicForm = ({ fields, register, errors }) => {
    ...
    const handleChange = (e, notReqVal, action) => {
            ...
            case "text":
                return (
                    <div className="form-item" key={field.name}>
                        ...
                        {errors[field?.name] && <p className="err-msg">{errors[field?.name]?.message}</p>}
                    </div>
                );
            case "select":
                return (
                                ...
                                {field.options.map((option) => (
                                    <li key={option.value}>
                                        <input
                                            ...
                                            {...register(field.name)}
                                            // onChange={(e) => handleChange(e, field.notReqVal, field?.action)}
                                        />
    ...
    return <div className="otr-form">{fields.map((field) => renderField(field))}</div>;
};
