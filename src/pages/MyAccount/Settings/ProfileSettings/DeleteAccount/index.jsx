...
const DeleteAccount = () => {
	...
	const renderStepOne = () => {
		return (
			<>
				...
				<span className="capt">
					Delete your account will removed all personal data!
				</span>
		...
		return (
			<>
				...
				<p className="question">
					We’ re sorry to see you go. We ‘d like to know why you ‘re deleting
					your account as we may be able to help with common issues.
				</p>
				<ul>
	...
	const renderStepThree = () => {
		return (
			<>
				<h1 className="align-left">Confirm Permanent Account Deletion?</h1>
				<span className="capt align-left">
					If you continue your account deletion, your profile and account
					details will be deleted on Jul 10,2024. You won’t be visible on App
					between now and then. You can cancel the permanent deletion process
					anytime before the process starts through accounts centre or by
					logging in to your Account.
				</span>
				<div className="atn-btn-box vertical">
					<button onClick={() => setStep((prev) => prev + 1)}>
						<RiDeleteBin6Fill className="icon" /> Delete Account
					</button>
					<button className="cnl-btn" onClick={() => setStep(1)}>
						Cancel
					</button>
				</div>
			</>
